...
void SQLiteDataSource::createTable()
{
    ...
    std::string sqlStr = "CREATE TABLE IF NOT EXISTS newcontact"
...
ErrorInfo SQLiteDataSource::getContact(Contact::ContactId id, Contact& c)
{
    ...
    std::string sqlStr = "SELECT * FROM newcontact WHERE id=?;";
...
{
    //create sql prepared statement
    std::string sqlStr = "SELECT * FROM newcontact;";
...
{
    //create sql prepared statement
    std::string sqlStr = "INSERT INTO newcontact VALUES("
                        "NULL,?,?,?,?,?,?);";
...
{
    //create sql prepared statement
    std::string sqlStr = "UPDATE newcontact SET "
                         "firstname=?, lastname=?,"
                         "phonenum=?, address=?,"
...
ErrorInfo SQLiteDataSource::deleteContact(Contact::ContactId id)
{
    ...
    //create sql prepared statement
    std::string sqlStr = "DELETE FROM newcontact WHERE id=?;";
...
{
    //create sql prepared statement
    std::string sqlStr = "DELETE FROM newcontact;";
